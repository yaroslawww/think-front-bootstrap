...
<div class="container mx-auto relative" style="z-index: 2">
  ...
  <div class="flex flex-col sm:flex-row justify-between relative mb-8">
    <div
      class="load-more-box__total w-full pt-4 justify-end order-last sm:order-first text-example-dark font-judson text-xl md:text-2xl flex items-center sm:pt-0 sm:justify-start">
        ...
        <section
          ...
          <div class="simple-modal__content bg-white relative w-full max-w-2xl mx-auto h-full flex flex-col">
            ...
            >
              ...
              >
                <a
                  class="our-example-search-filter__clear cursor-pointer text-example hover:text-example-dark transition-all duration-500">
                  Clear filters
                </a>
              </div>
              ...
              >
                <div
                  class="cursor-pointer text-example hover:text-example-dark transition-all duration-500 block w-5 h-5">
  ...
  <div
    class="load-more-box <?= ( $moreManager->totalPages() <= 1 ) ? 'load-more-box--all-showed' : '' ?> <?= ( $moreManager->totalCount() <= 0 ) ? 'load-more-box--empty' : '' ?>"
  "
  ...
  <div class="load-more-box__list relative flex flex-wrap -mx-4 mb-8">
    ...
    <div class="load-more-box__empty justify-center items-center py-12 h-64">
      <div class="font-judson text-2xl md:text-4xl text-center p-8 bg-example-dark text-white">
        No examples found according search criteria
      </div>
    </div>
  </div>
